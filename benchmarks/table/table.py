...
from benchmarks.table.scoring import wrap_table_html, similarity_eval_html
...
@click.option("--against", type=click.Choice(["fintabnet", "synthtabnet"]), 
              default="fintabnet", help="Dataset to use.")
@click.option("--dataset", type=str, default=None, 
              help="Huggingface dataset to use. Default: datalab-to/fintabnet_bench_marker")
